...
class SurveyUserInputLine(models.Model):
    ...
    def get_display_answer(self):
        ...
        mapping = {
            ...
            'numerical_box': str(self.value_numerical_box) if self.value_numerical_box is not None else '',
            'date': fields.Date.to_string(self.value_date) if self.value_date else '',
            'datetime': fields.Datetime.to_string(self.value_datetime) if self.value_datetime else '',
        }
